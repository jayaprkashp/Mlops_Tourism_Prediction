...
Xtrain_path = "hf://datasets/jayaprakashp1/tourism-package-prediction/Xtrain.csv"
Xtest_path = "hf://datasets/jayaprakashp1/tourism-package-prediction/Xtest.csv"
ytrain_path = "hf://datasets/jayaprakashp1/tourism-package-prediction/ytrain.csv"
ytest_path = "hf://datasets/jayaprakashp1/tourism-package-prediction/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "best_tourism_package_prediction_model.joblib"
    ...
    api.upload_file(
        path_or_fileobj="best_tourism_package_prediction_model.joblib",
        path_in_repo="best_tourism_package_prediction_model.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
